...
The `evaluating-cmr-in-mm` maintainers take all security issues in the project
seriously. Thank you for improving the security of `evaluating-cmr-in-mm`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`evaluating-cmr-in-mm` leverages GitHub's private vulnerability reporting.
