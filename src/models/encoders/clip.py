...
AVAILABLE_MODELS = ("clip-ViT-B-32", "clip-ViT-B-16", "clip-ViT-L-14")
...
class CLIP(nn.Module):
    ...
    def compute_caption_embeddings(
        self, ds_split: Type[Dataset], compute_from_scratch
        ...
        if compute_from_scratch:
            ...
            capt_emb = self.encode(
                [
                    ds_split.captions[caption_id]["raw"][
    ...
    def compute_image_embeddings(
        self, compute_from_scratch, chunk_size=1000
